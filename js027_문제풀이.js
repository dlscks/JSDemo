...
//   result = data.split("://");
//   return `protocol: ${result[0]}, domain ${result[1]}`;
// }
// console.log(separator("http://www.daum.net"));
// console.log(separator("ftp://ftp.microsoft.com"));
// 강사님
function separator(data) {
  let arr = data.split("://");
  console.log(`protocoal: ${arr[0]}, domain:${arr[1]}`);
}
